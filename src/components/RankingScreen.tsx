      ...
      <div className="flex items-center gap-2">
        ...
        <Popover>
          ...
          <PopoverContent className="max-w-xs text-xs text-muted-foreground space-y-1.5">
            <p><b>Geral:</b> gol +7, passe decisivo +5, defesa de goleiro +6, defesa de linha +3, frango -5, falta -3, amarelo -8, vermelho -15. Avaliação: nota 5 = +20, nota 4 = +10 (nota baixa nunca desconta). +1 por vitória do time, +5 se foi campeão da pelada.</p>
