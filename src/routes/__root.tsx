...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FUTZONE — A pelada ficou séria." },
      { name: "description", content: "FUTZONE: organize, sorteie e gamifique suas peladas de futebol." },
      { name: "author", content: "FUTZONE" },
      { property: "og:title", content: "FUTZONE — A pelada ficou séria." },
      { property: "og:description", content: "FUTZONE: organize, sorteie e gamifique suas peladas de futebol." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "FUTZONE — A pelada ficou séria." },
      { name: "twitter:description", content: "FUTZONE: organize, sorteie e gamifique suas peladas de futebol." },
