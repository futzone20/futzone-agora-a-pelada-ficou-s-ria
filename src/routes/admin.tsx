...
import { LayoutDashboard, Users, MapPin, Handshake, Megaphone, Gamepad2, DollarSign, MessageSquare, Palette, Star } from "lucide-react";
  ...
  component: () => (
    <RequireAuth allow={["admin"]}>
      <DashboardShell title="Super Admin" items={[
        ...
        { to: "/admin/grupos", label: "Avaliações", icon: Star },
